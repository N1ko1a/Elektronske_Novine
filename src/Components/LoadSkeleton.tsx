function LoadSkeleton() {
  return (
    ...
    <div className="flex flex-col justify-center items-center w-60 h-44 rounded-3xl bg-gray-200 animate-pulse">
      {/*Ovaj je za image */}
      <div className="w-56 h-32 rounded-3xl bg-gray-400"></div>
